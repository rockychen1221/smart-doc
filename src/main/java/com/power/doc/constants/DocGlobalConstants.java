...
public class DocGlobalConstants {
    ...
    //添加模板的国际化内容
    public static final String RESPONSE_FIELDS_CN = "响应-字段";
    public static final String RESPONSE_FIELDS_EN = "Response-fields";
    public static final String RESPONSE_FIELDS_HEADE_EN = "Field | Type| Description | Since";
    public static final String RESPONSE_FIELDS_HEADE_CN = "字段 | 类型| 描述 | 版本";


    public static final String RESPONSE_EXAMPLE_CN = "响应-示例";
    public static final String RESPONSE_EXAMPLE_EN = "Response-example";
